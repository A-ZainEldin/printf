 ...
 * Return: Number of chars printed.
 */
int printingNum(int is_negative, int ind, char buffer[],
	int flags, int width, int precision, int size)
{
...
/**
 * fun_print_num - Write a number using a bufffer
 ...
 */
int fun_print_num(int ind, char buffer[],
...
/**
 * fun_to_write_unsgnd - writes an unsigned number
 ...
 */
int fun_to_write_unsgnd(int is_negative, int ind,
	char buffer[],
	int flags, int width, int precision, int size)
{
...
/**
 * fun_to_write_pointer - Write a memory address
 ...
 * Return: Number of written chars.
 */
int fun_to_write_pointer(char buffer[], int ind, int length,
