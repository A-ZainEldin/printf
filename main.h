...
int deal_with_print(const char *fmt, int *din,
...
int handle_write_character(char c, char buffer[],
	int flags, int width, int precision, int size);
int printingNum(int is_positive, int ind, char buffer[],
	int flags, int width, int precision, int size);
int fun_print_num(int ind, char bff[], int flags, int width, int precision,
